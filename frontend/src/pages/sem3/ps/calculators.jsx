...
const Indep_events = () => {
  return (
    <div>
        <a href="https://docs.google.com/spreadsheets/d/12CyObWv1W8G5mN8uimbsupRTPuwhOi78Pwpt_KeqC6w/edit?usp=sharing" target="_blank">Click Me</a>
    </div>
  )
}

export default Indep_events